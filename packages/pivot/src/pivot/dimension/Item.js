...
Ext.define('Ext.pivot.dimension.Item', {
    ...
    * You can either provide a function name available in {Ext.pivot.Aggregators} or
    * set your own function.
    * 
    * It's probably best to override {Ext.pivot.Aggregators} and add your own functions
    * to be able to serialize this when having a stateles pivot grid.
    * 
    * @cfg
    * @type String
    */
    ...
    */
    defaultSorterFn: function(o1, o2){
        ...
        result = Ext.pivot.matrix.Abstract.prototype.naturalSort(s1, s2);
