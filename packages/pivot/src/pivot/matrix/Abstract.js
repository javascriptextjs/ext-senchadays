...
* 
*/
Ext.define('Ext.pivot.matrix.Abstract', {
    alternateClassName: [
    ...
    requires: [
        ...
        'Ext.pivot.axis.Abstract',
        'Ext.pivot.dimension.Item',
        'Ext.pivot.matrix.Results'
    ],
    ...
    */
     ...
     * @cfg mztypeLeftAxis
     * @type String
     * @deprecated 6.0 Use {@link #typeLeftAxis} instead.
     */
    ...
    */
     ...
     * @cfg mztypeTopAxis
     * @type String
     * @deprecated 6.0 Use {@link #typeTopAxis} instead.
     */
    ...
    */
    ...
    constructor: function(config){
        ...
        *
        * @event cleardata
        * @param {Ext.pivot.matrix.Abstract} matrix Reference to the Matrix object
        */
    ...
    */
    initResults: function(){
        ...
        me.results = Ext.create('Ext.pivot.matrix.Results', me);
    },
    ...
    */
    ...
    deprecated: {
        '6.0': {
            properties: {
                mztype: 'type',
                mztypeLeftAxis: 'typeLeftAxis',
                mztypeTopAxis: 'typeTopAxis'
            }
        }
    }
});