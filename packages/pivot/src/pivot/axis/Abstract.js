...
*/
Ext.define('Ext.pivot.axis.Abstract', {
    alternateClassName: [
    ...
    */
    ...
    /**
    * Create a {Ext.pivot.dimension.Item} object with the specified config and add it to the
    ...
    */
    addDimension: function(config){
        ...
        if(config){
            me.dimensions.add(Ext.create('Ext.pivot.dimension.Item', Ext.apply({matrix: me.matrix}, config)));
        }
    },
