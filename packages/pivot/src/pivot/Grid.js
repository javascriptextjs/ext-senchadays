...
Ext.define('Ext.pivot.Grid', {
    ...
    * is a configuration object used to instantiate a {Ext.pivot.dimension.Item}.
    * 
#Example usage:#
...
#Example usage:#
    ...
    * @returns {Ext.pivot.matrix.Abstract}
    * 
    */
    getMatrix: function(){
        return this.matrix;
    ...
    *        You could extend {Ext.pivot.Aggregators} to add your own function
