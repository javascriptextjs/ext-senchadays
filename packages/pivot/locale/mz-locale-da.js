...
Ext.define('Mz.locale.da.pivot.Grid', {
...
Ext.define('Mz.locale.da.pivot.plugin.configurator.Panel', {
...
Ext.define('Mz.locale.da.pivot.plugin.configurator.Column', {
...
Ext.define('Mz.locale.da.pivot.plugin.configurator.FilterTopWindow',{
    titleText:      'Top 10 filter ({0})',
    fieldText:      'Vis',
    sortResultsText:'Sorter resultat'
});

Ext.define('Mz.locale.da.pivot.plugin.configurator.FilterLabelWindow',{
    titleText:          'Label filter ({0})',
    fieldText:          'Vis elementer for hvilke',
    caseSensitiveText:  'Case sensitive'
});

Ext.define('Mz.locale.da.pivot.plugin.configurator.FilterValueWindow',{
    titleText:      'Value filter ({0})',
    fieldText:      'Vis elementer for hvilke'
});

Ext.define('Mz.locale.da.pivot.plugin.RangeEditor', {
