 ...
 * It prepares the pivot data for export.
 *
 * @private
 *
 */
Ext.define('Ext.exporter.Formatter', {
    /**
    ...
    */
    ...
    /**
    * Set this to false if you don't want to export totals
    * 
    * @type Boolean
    */
    includeTotals:      true,
    ...
    */
    constructor: function (config) {
        ...
        me.includeTotals = config.includeTotals;
